<nav class="navbar navbar-default navbar-static-top m-b-0">
    <div class="navbar-header">
        ...
        <div class="top-left-part">
            <a class="logo" href="{{ route('dashboard') }}"><b>
                    <!--This is dark logo icon-->
                    <img src="{{ asset('adminassets/plugins/images/eliteadmin-logo.png') }}" alt="home" class="dark-logo" />
                    <!--This is light logo icon-->
                    <img src="{{ asset('adminassets/plugins/images/eliteadmin-logo-dark.png') }}" alt="home" class="light-logo" />
                </b>
                <span class="hidden-xs">
                        <!--This is dark logo text-->
                        <img src="{{ asset('adminassets/plugins/images/eliteadmin-text.png') }}" alt="home" class="dark-logo" />
                    <!--This is light logo text-->
                        <img src="{{ asset('adminassets/plugins/images/eliteadmin-text-dark.png') }}" alt="home" class="light-logo" />
                    </span>
            </a>
        </div>
        ...
        <ul class="nav navbar-top-links navbar-right pull-right">
                ...
                <ul class="dropdown-menu mailbox animated bounceInDown">
                    ...
                    <li>
                        <div class="message-center">
                            <a href="#">
                                <div class="user-img">
                                    <img src="{{ asset('adminassets/plugins/images/users/pawandeep.jpg') }}"
            ...
            <li class="dropdown"> <a class="dropdown-toggle waves-effect waves-light" data-toggle="dropdown" href="#"><i class="ti-shopping-cart"></i>
                ...
                <ul class="dropdown-menu dropdown-cart dropdown-tasks animated slideInUp">
                    <li>
                        <div class="cart-img"><img src="{{ asset('adminassets/plugins/images/chair.jpg') }}"/></div>
                        <div class="cart-content"><h5>Rounded Chair</h5><small>$153</small></div>
                    </li>
                    <li class="divider"></li>
                    <li>
                        <a class="text-center" href="product-checkout.html">
